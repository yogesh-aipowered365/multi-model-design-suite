...
def ingest_documents(knowledge_base_path: str = None) -> List[Chunk]:
    """
...
class RAGService:
    """RAG Service with caching for fast lookups."""

    def __init__(self, index_name: str = "default"):
        """Initialize RAG service with cached index."""
...
_retriever_instance: Optional[RAGService] = None


def get_rag_service(index_name: str = "default") -> RAGService:
    """Get or create RAG service instance."""
    global _retriever_instance
    if _retriever_instance is None:
        _retriever_instance = RAGService(index_name)
